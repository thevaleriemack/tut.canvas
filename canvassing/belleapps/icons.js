...
document.getElementById("logo").style.top = (tipt+360).toString()+"px";
...
document.getElementById("earn").style.right = (midwid-260).toString()+"px";
document.getElementById("earn").style.top = (tipt+960).toString()+"px";

document.getElementById("route").style.right = (midwid-270).toString()+"px";
document.getElementById("route").style.top = (tipt+1290).toString()+"px";
...
document.getElementById("circle").style.top = (tipt+1670).toString()+"px";

document.getElementById("confirm").style.left = (midwid-62).toString()+"px";
document.getElementById("confirm").style.top = (tipt+1715).toString()+"px";

document.getElementById("receipt").style.left = (midwid-80).toString()+"px";
document.getElementById("receipt").style.top = (tipt+1840).toString()+"px";
